...
//DEATHS HIDDEN
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	local function CETS_HideDeaths(ply)
		if GetConVar("cets_hide_death_notice"):GetInt() == 1 then
			ply:SendLua("RunConsoleCommand('hud_deathnotice_time', '0')")
		end
	end

	hook.Add("PlayerInitialSpawn", "HideDeaths_CETS", CETS_HideDeaths)	
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//PHYSPLAY
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	local HeldAngles = {}
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	local IMPULSE = 76
	local NPC_CLASS = "npc_hecu_vj_cets"

	hook.Add("StartCommand", "HardcodedImpulse76Spawn", function(ply, cmd)
		if not IsValid(ply) then return end
		if cmd:GetImpulse() ~= IMPULSE then return end
		...
		spawnPos = spawnPos + tr.HitNormal * 8

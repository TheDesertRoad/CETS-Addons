...
ENT.Model = "models/props_cets/hecu_mount_gun01.mdl"
...
function ENT:DoShoot(destination)
	...
	self:EmitSound("Cets_Weapon_HMG1.Fire")
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function ENT:DoInit()
	local mdl = self:SetupCustomModel("models/weapons/w_rocket_launcher.mdl", 1)

	mdl:ManipulateBoneScale(4, Vector(0, 0, 0))

	local mat = Matrix()
	mat:Rotate(Angle(0, 90, 100))
	mat:Translate(Vector(0, -5, 1))

...
VJ.AddNPC("Super Particle Storm", "npc_super_particlestorm_vj_cets",vCat)
...
VJ.AddConVar("sv_cets_friends_join_sound", 1, FCVAR_ARCHIVE)
VJ.AddConVar("sv_cets_friends_chat_sound", 1, FCVAR_ARCHIVE)
...
VJ.AddConVar("cets_dance_music", 1, FCVAR_ARCHIVE)
...
VJ.AddConVar("cl_cets_custom_hev_wear", 1, FCVAR_ARCHIVE)
VJ.AddConVar("cl_cets_custom_hev_freeze", 1, FCVAR_ARCHIVE)
VJ.AddConVar("cl_cets_custom_hev_voice", 0, FCVAR_ARCHIVE)
...
VJ.AddConVar("cets_spawnable_nuke", 1, FCVAR_ARCHIVE)
...
VJ.AddConVar("sk_cets_antidote_time", 15, FCVAR_ARCHIVE)

game.AddDecal("VJ_CETS_EggYolk", {"decals/egg_yolk"})
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
if SERVER then

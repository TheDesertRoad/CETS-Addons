...
function SWEP:Init()
	...
	self.FireLoop1 = CreateSound(self, "ambient/levels/citadel/zapper_loop1.wav")
	self.FireLoop1:SetSoundLevel(80)
	self.FireLoop2 = CreateSound(self, "ambient/levels/citadel/zapper_loop2.wav")
...
function SWEP:OnPrimaryAttack(status, statusData)
	if status == "Init" then
		...
		util.ParticleTracerEx("vortigaunt_beam", self:GetAttachment(1).Pos, randPos, false, self:EntIndex(), 1)

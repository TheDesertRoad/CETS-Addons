...
function ENT:Explode()
	...
	ParticleEffect("assassin_projectile_explosion_2k", self:GetPos(), Angle(0,0,0))
	effects.BeamRingPoint(  self:GetPos(), 0.35, 0, 16, 13, 13, Color(0,255,75) )

	util.ScreenShake(self:GetPos(), 6, 200, 0.66, 32)
        ...
        self:EmitSound(table.Random({"npc/ministrider/flechette_explode1.wav","npc/ministrider/flechette_explode2.wav","npc/ministrider/flechette_explode3.wav"}),90,math.random(105, 110), 0.85)

...
ENT.Model = {"models/weapons/w_comgrenade.mdl"}
...
function ENT:CustomOnInitialize()
	...
	beepSound(0, "weapons/grenade/tick1.wav")
	beepSound(0.5, "weapons/grenade/tick1.wav")
	beepSound(1.0, "weapons/grenade/tick1.wav")
	beepSound(1.6, "weapons/grenade/tick1.wav")
	beepSound(1.9, "weapons/grenade/tick1.wav")
	beepSound(2.2, "weapons/grenade/tick1.wav")
	beepSound(2.4, "weapons/grenade/tick1.wav")
	beepSound(2.6, "weapons/grenade/tick1.wav")
	beepSound(2.7, "weapons/grenade/tick1.wav")
	beepSound(2.8, "weapons/grenade/tick1.wav")
	beepSound(2.9, "weapons/grenade/tick1.wav")
	...
	util.SpriteTrail(self, 1, Color(255, 0 ,0), true, 8, 0.5, 1.0, 0.1, "effects/blueblacklargebeam")
...
function ENT:OnDestroy()
	...
	if self:WaterLevel() > 1 then 
		VJ.EmitSound(self, "weapons/underwater_explode" .. math.random(3, 4) .. ".wav", 100, 100)
		util.ScreenShake(myPos, 5, 35, 1, 313)

		ParticleEffect("water_gren_test1", self:GetPos(), Angle(0,0,0), nil)
	else
		VJ.EmitSound(self, "weapons/explode_alt" .. math.random(3, 5) .. ".wav", 100, 100)

...
ENT.SoundTbl_Breath = {"weapons/grenade/grenade_acid_loop_01.wav", "weapons/grenade/grenade_acid_loop_01.wav"}
ENT.SoundTbl_Death = {"weapons/grenade/grenade_acid_fadeout.wav"}
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:CustomOnInitialize ()
	...
	util.Decal(VJ.PICK("VJ_CETS_BurntScorch2"), tr.HitPos + tr.HitNormal, tr.HitPos - tr.HitNormal)
end
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:Touch(ply)
	if math.random(1, 2) == 1 && ply:IsPlayer() then
		VJ.EmitSound(self, "weapons/grenade/grenade_acid_hit_01.wav", 100)
	end
end
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:CustomOnThink()
	...
	util.VJ_SphereDamage(self,self,self:GetPos(),36,1,DMG_ACID,true,true, {Force = 1})

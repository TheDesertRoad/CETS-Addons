...
-----------------------------------------------*/
ENT.Model = "models/hl2_fassassin.mdl"
ENT.StartHealth = GetConVar("sk_fassassin_health"):GetInt()
...
ENT.DisableWeaponReloadAnimation = true--false -- Disables the default reload animation code

...
VJ.AddNPC("Super Synth","npc_supersynth_vj_cets",vCat)
VJ.AddNPC("Assault Synth","npc_assault_synth_vj_cets",vCat)

VJ.AddNPC("Outlands Overwatch Assassin","npc_hunterfassassin_vj_cets",vCat1)

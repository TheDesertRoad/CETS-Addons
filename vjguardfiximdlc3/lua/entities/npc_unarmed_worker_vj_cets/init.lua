...
local mdlMal = {
	"models/humans/human_workers/group01/male_01.mdl",
	"models/humans/human_workers/group01/male_09.mdl",
	"models/humans/human_workers/group02/male_01.mdl",
	"models/humans/human_workers/group02/male_09.mdl",
	"models/humans/human_workers/group03/male_01_bloody.mdl",
	"models/humans/human_workers/group03/male_09_bloody.mdl",
	"models/humans/human_workers/group03m/male_01.mdl",
	"models/humans/human_workers/group03m/male_09.mdl",
}
...
function ENT:OnDeathWeaponDrop(dmginfo, hitgroup, wepEnt)
	...
	elseif self.Weapon_Rand == 2 then
		for i = 1, 1 do
			...
			local shotgun = ents.Create("weapon_pistol")

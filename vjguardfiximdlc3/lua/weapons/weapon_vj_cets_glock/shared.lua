...
if CLIENT then
	function SWEP:CreateWeaponSelectionFonts(height)
		...
		surface.CreateFont("CETS_G18font_Glow", {
			font = "CETS",
		...
		surface.CreateFont("CETS_G18font", {
			font = "CETS",
	...
	SWEP.DrawWeaponSelection = function(self, x, y, w, h, alpha)
		...
		draw.SimpleText(icon, "CETS_G18font_Glow", cx, cy, Color(r, g, b, glowAlpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		draw.SimpleText(icon, "CETS_G18font", cx, cy, Color(r, g, b, alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
end
...
SWEP.DrawWeaponInfoBox	= false
SWEP.BounceWeaponIcon = false 	
SWEP.ViewModel = "models/weapons/c_hl2_mp5.mdl"
SWEP.WorldModel = "models/weapons/w_hl2_mp5.mdl"
...
--------------------------------------------------------------------------------|
SWEP.Primary.Damage				= GetConVar("sk_plr_cets_dmg_mp5sd"):GetInt() -- Damage
SWEP.Primary.ClipSize			= GetConVar("sk_max_cets_mp5sd"):GetInt() -- Max amount of bullets per clip
SWEP.Primary.Delay				= 0.09 -- Time until it can shoot again
SWEP.Primary.Sound				= "Cets_Weapon_MP5SD.Fire"
SWEP.Primary.TakeAmmo 			= 1
SWEP.Primary.Recoil				= .3
SWEP.Primary.Spread 			= .55   
SWEP.Primary.DefaultClip		= GetConVar("sk_max_cets_mp5sd_bullet"):GetInt()
...
function SWEP:PrimaryAttack(UseAlt)
	...
	-- Firing Sounds
	if SERVER then
		local fireSd = VJ.PICK("Cets_Weapon_MP5SD.Fire")
...
if CLIENT then
	function SWEP:CreateWeaponSelectionFonts(height)
		...
		surface.CreateFont("CETS_MP5SDfont_Glow", {
			font = "CETS",
		...
		surface.CreateFont("CETS_MP5SDfont", {
			font = "CETS",
	...
	SWEP.DrawWeaponSelection = function(self, x, y, w, h, alpha)
		...
		draw.SimpleText(icon, "CETS_MP5SDfont_Glow", cx, cy, Color(r, g, b, glowAlpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		draw.SimpleText(icon, "CETS_MP5SDfont", cx, cy, Color(r, g, b, alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
end
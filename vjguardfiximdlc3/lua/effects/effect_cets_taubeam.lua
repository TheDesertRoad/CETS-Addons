...
function EFFECT:CreateZap()
	...
	for i = 0, segments do
		...
		local offset = right * wave * math.Rand(0, 4) + up * wave * math.Rand(0, 4)
		offset = offset * math.sin(frac * math.pi)
...
function EFFECT:Render()
	...
	render.DrawBeam( self.StartPos, self.EndPos, 4, self.texcoord, self.texcoord + self.Length / 1024, Color( 255, 255, 0, 255) )

...
-----------------------------------------------*/
ENT.Model = "models/hl2_houndeye.mdl"
ENT.StartHealth = GetConVar("sk_cets_hound_health"):GetInt()
...
ENT.ThumperFearRadius = 500
ENT.ThumperSafeDistance = 500
...
function ENT:Init()
	...
	if !IsValid(SquadC_Leader) && string.lower(self:GetModel()) == "models/hl2_houndeye.mdl" or bit.band(flags, 32) ~= 0 or self:HasSpawnFlags(32) then
...
function ENT:CustomOnThink(ent)
	...
	if IsValid(leader) then
		...
		if string.lower(self:GetModel()) == "models/hl2_houndeye.mdl" or bit.band(flags, 32) ~= 0 or self:HasSpawnFlags(32) then
			VJ.SquadC_Leader = self
		end
	end
end
...
function ENT:OnInput(key, activator, caller, data)
	...
	if key == "hunt" then
		VJ.EmitSound(self, "npc/houndeye/he_hunt" .. math.random(1, 4) .. ".wav")
	end
end
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:OnMeleeAttackExecute(status, ent, isProp)
	...
	if status == "Init" then
		...
		if GetConVar("npc_cets_hounds_xenfriends"):GetInt() == 1 then
			effects.BeamRingPoint(self:GetPos() +Vector(0, 0, 5), 0.6, 2, 700, 16, 0, Color(188, 220, 255))
			effects.BeamRingPoint(self:GetPos() +Vector(0, 0, 5), 0.6, 2, 300, 32, 0, Color(188, 220, 255))
		...
		elseif alliesNum == 1 && GetConVar("npc_cets_hounds_xenfriends"):GetInt() == 0 then
			effects.BeamRingPoint(self:GetPos() +Vector(0, 0, 5), 0.6, 2, 700, 16, 0, Color(101, 133, 221))
			effects.BeamRingPoint(self:GetPos() +Vector(0, 0, 5), 0.6, 2, 300, 32, 0, Color(101, 133, 221))
		...
		elseif alliesNum == 2 && GetConVar("npc_cets_hounds_xenfriends"):GetInt() == 0 then
			effects.BeamRingPoint(self:GetPos() +Vector(0, 0, 5), 0.6, 2, 700, 16, 0, Color(67, 85, 255))
			effects.BeamRingPoint(self:GetPos() +Vector(0, 0, 5), 0.6, 2, 300, 32, 0, Color(67, 85, 255))
		...
		elseif alliesNum == 3 && GetConVar("npc_cets_hounds_xenfriends"):GetInt() == 0 then
			effects.BeamRingPoint(self:GetPos() +Vector(0, 0, 5), 0.6, 2, 700, 16, 0, Color(62, 33, 211))
			effects.BeamRingPoint(self:GetPos() +Vector(0, 0, 5), 0.6, 2, 300, 32, 0, Color(62, 33, 211))
		...
		elseif alliesNum > 3 && GetConVar("npc_cets_hounds_xenfriends"):GetInt() == 0 then
			effects.BeamRingPoint(self:GetPos() +Vector(0, 0, 5), 0.6, 2, 700, 16, 0, Color(31, 15, 255))
			effects.BeamRingPoint(self:GetPos() +Vector(0, 0, 5), 0.6, 2, 300, 32, 0, Color(31, 15, 255))

...
-----------------------------------------------*/
ENT.Model = "models/headcrabcombine.mdl"
ENT.StartHealth = 80
...
ENT.AnimTbl_Walk = "run1"
ENT.AnimTbl_Run = "run1"
---------------------------------------------------------------------------------------------------------------------------------------------
...
ENT.LeapAttackVelocityForward = 90
ENT.LeapAttackVelocityUp = 300
ENT.LeapAttackDamage = 24
...
ENT.LeapAttackDamageSoundLevel = 80
...
ENT.SoundTbl_LeapAttackDamage = "npc/ministrider/ministrider_skewer1.wav"
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:Init()

...
-----------------------------------------------*/
ENT.Model = "models/hl2_archer.mdl"
ENT.StartHealth = 100
ENT.SightAngle = 225
...
function ENT:OnMeleeAttackExecute(status, ent, isProp)
	if status == "Init" then
		...
		effects.Bubbles(pos +Vector(-32, -32, -32), pos +Vector(32, 32, 32), math.random(32, 64), math.random(100, 300), 1)
	end
end
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:CustomOnTakeDamage_OnBleed(dmginfo,hitgroup)
	if dmginfo:IsDamageType( DMG_PHYSGUN ) or dmginfo:IsDamageType( DMG_CRUSH ) then 
			...
			effects.Bubbles(self:GetPos() +(self:OBBMins() *0.5), self:GetPos() +(self:OBBMaxs() *0.5), math.random(32, 64), math.random(100, 300), 1)
